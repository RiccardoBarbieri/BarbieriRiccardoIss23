...
public class CmdConsoleRemote extends ActorNaiveCaller implements Observer {
    private final String[] buttonLabels = new String[]{"start", "stop", "resume", "getpath"};
    private final String myName;
    private IApplMessage curMsg;
    private final IApplMessage applRunningRequest;
	private final IApplMessage applGetPathRequest;
